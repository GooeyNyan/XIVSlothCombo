...
namespace XIVSlothCombo.CustomComboNS.Functions
{
    internal abstract partial class CustomComboFunctions
    {
        ...
        public static bool CanWeave(uint actionID, double weaveTime = 0.4) => (GetCooldown(actionID).CooldownRemaining > weaveTime) || (HasSilence() && HasPacification());
        ...
        /// <returns> True or false. </returns>
        public static bool CanSpellWeave(uint actionID, double weaveTime = 0.4)
        {
